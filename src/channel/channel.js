...
class Channel {
	constructor(type = 'relay') {
        ...
        this.oneTerminalSubject.filter(v => false)._subscribeProxy(this.otherTerminalSubject)
        this.otherTerminalSubject.filter(v => false)._subscribeProxy(this.oneTerminalSubject)
        this.oneChannel = new ChannelTerminal(this.oneTerminalSubject, this.otherTerminalSubject)
        this.otherChannel = new ChannelTerminal(this.otherTerminalSubject, this.oneTerminalSubject)
	}
}
